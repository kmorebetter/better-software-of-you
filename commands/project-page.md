...
Include the nav bar from `navigation-patterns.md` at the top of the page — "Dashboard" breadcrumb link + pills for other generated entity pages (excluding the current project). Show the current project name as the breadcrumb text.
