...
These cross-cutting views are sub-pages of Dashboard — they do NOT appear in the primary nav bar. Instead, they are accessed via the Intelligence Tools strip on the dashboard itself.
